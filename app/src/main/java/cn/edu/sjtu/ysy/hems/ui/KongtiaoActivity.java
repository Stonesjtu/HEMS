...
public class KongtiaoActivity extends Activity{
  ...
  //  public static final String[] apower={"2500","300","150","1500","600","1000","3000","100"};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ynyouhua=shp.getBoolean("if_sunny", true);
        initEntriesData();
        initLableData();
        show();
      ...
      //  String strurl="http://10.189.170.2:800/ysy";
        ...
        if(ynyouhua==true) {
            switch (index) {
                case 0:
                    ...
                    dt.setText(""+MainActivity.Kongtiao.getdT());
                ...
                case 3:
                    ...
                    dt.setText(""+MainActivity.Reshuiqi.getdT());
        ...
        else  LinLayappcat.setVisibility(View.GONE);
        //jump
...
//        chart.animateX(5000);
                    ...
                    if (starttimeint[index] > 23 || starttimeint[index] < 0 || overtimeint[index] > 24
                        ...
                        switch (index) {
                            case 0:
                                ...
                                dT[index]= Integer.parseInt(dt.getText().toString());
                                if (Tset[index] > 32 || Tset[index] < 16 || dT[index] < 0 || dT[index] > 5) {
                                ...
                                MainActivity.Kongtiao.setdT(dT[index]);
                            ...
                            case 3:
                                Tset[index] = Integer.parseInt(tset.getText().toString());
                                dT[index]= Integer.parseInt(dt.getText().toString());
                                if (Tset[index] > 70 || Tset[index] < 10 || dT[index] < 0 || dT[index] > 10) {
                                    Toast.makeText(getApplicationContext(), "您输入的温度范围无法实现", Toast.LENGTH_LONG).show();
                                    break;
                                }
                                ...
                                MainActivity.Reshuiqi.setdT(dT[index]);
    ...
    private void showDialog() {
        ...
        builder.setMessage("您输入的时间不合法，请修改");
